...
export const translations = {
  en: {
    ...
    "popup.lockActive": "Locked",
    "popup.lockError": "Settings are locked.",
    ...
    "settings.scheduleAdd": "+ Add Schedule",
    "settings.scheduleSlotName": "Schedule name",
    "settings.scheduleLimit": "Maximum 5 schedules reached.",
    "settings.scheduleDays": "Days",
    "settings.scheduleRemove": "Remove",
    ...
    "settings.sectionLock": "Nuclear Lock",
    "settings.lockDesc": "Lock all settings and site removals for a set duration. Cannot be undone early.",
    "settings.lockFor": "Lock for (hours)",
    "settings.lockActivate": "Activate Lock",
    "settings.lockActive": "Locked",
    "settings.lockUntil": "Settings locked until",
    "settings.lockError": "Settings are locked.",
  ...
  de: {
    ...
    "popup.lockActive": "Gesperrt",
    "popup.lockError": "Einstellungen sind gesperrt.",
    ...
    "settings.scheduleAdd": "+ Zeitplan hinzufügen",
    "settings.scheduleSlotName": "Name",
    "settings.scheduleLimit": "Maximal 5 Zeitpläne erreicht.",
    "settings.scheduleDays": "Tage",
    "settings.scheduleRemove": "Entfernen",
    "settings.scheduleFrom": "Von",
    ...
    "settings.sectionLock": "Sperre",
    "settings.lockDesc": "Alle Einstellungen und Seiten-Entfernungen für eine bestimmte Dauer sperren. Kann nicht früher rückgängig gemacht werden.",
    "settings.lockFor": "Sperren für (Stunden)",
    "settings.lockActivate": "Sperre aktivieren",
    "settings.lockActive": "Gesperrt",
    "settings.lockUntil": "Gesperrt bis",
    "settings.lockError": "Einstellungen sind gesperrt.",
